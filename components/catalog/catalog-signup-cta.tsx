...
export function CatalogSignupCta() {
  ...
  return (
    <section className="pb-16">
      <div className="mx-auto flex w-full max-w-[1366px] flex-col gap-8 bg-[linear-gradient(89deg,#404040_0%,#0D0D0D_100%)] px-4 py-10 sm:px-6 xl:h-[287px] xl:flex-row xl:items-center xl:justify-between xl:gap-12 xl:py-0 xl:pl-[56px] xl:pr-[125px]">
        <div className="min-w-0 max-w-[691px]">
          ...
          <p className="mt-3 text-[15px] font-normal leading-6 tracking-[0.4px] text-white sm:mt-4 sm:text-[18px] xl:text-[20px] xl:leading-6">
