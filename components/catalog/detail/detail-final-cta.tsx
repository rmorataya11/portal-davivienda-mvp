        ...
        <div className="overflow-hidden rounded-[32px] border border-[#E7EAEE] bg-white px-5 py-6 shadow-[0_18px_50px_rgba(20,31,37,0.06)] sm:px-8 sm:py-8">
          <div className="grid gap-6 lg:grid-cols-[1fr_320px] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 max-w-[720px] text-[34px] font-bold leading-[1.12] tracking-[0.3px] text-[#141F25] sm:text-[40px]">
                Revise el detalle técnico de esta API
              </h2>
              <div className="mt-4 h-1.5 w-14 rounded-full bg-[#E1251B]" />
              <p className="mt-5 max-w-[780px] text-[18px] leading-8 tracking-[0.24px] text-[#6A7178]">
            ...
            <div className="rounded-[26px] border border-[#E7EAEE] bg-[#F8F9FB] p-5">
              <div className="flex flex-col gap-3">
                ...
                <Link
                  ...
                  className="inline-flex h-12 min-w-[220px] items-center justify-center rounded-[30px] bg-[#E1251B] px-6 text-[15px] font-semibold text-white transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-[#E1111C]"
                >
                  Ver detalle técnico
                </Link>
                <ContractingRequestLink
                  href={`/solicitud-contratacion?producto=${api.slug}`}
                  className="inline-flex h-12 min-w-[220px] items-center justify-center rounded-[30px] border border-[#E1251B] bg-white px-6 text-[15px] font-medium text-[#E1251B] transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-[#FFF8F8]"
                >
