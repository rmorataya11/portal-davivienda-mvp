...
export function TallValueCard({ card }: { card: ValueCard }) {
  return (
    <article className="group flex min-h-[320px] w-full flex-col rounded-[32px] bg-white p-6 transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_24px_56px_rgba(20,31,37,0.14)] lg:row-span-2 lg:h-auto lg:min-h-0 lg:w-[302px]">
